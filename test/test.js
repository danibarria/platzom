...
const platzom = require('..').default //requiere dist/src/platzom.js
// escribimos para la funcion platzom, funcion()
describe('#platzom', function () {
    //it (descripcion, function () {})
  it('Si la palabra termina con "ar", se le quitan esas dos letras', function () {
    const translation = platzom("Programar") //hacemos una constante con el resultado
    expect(translation).to.equal("Program") //esperamos
  })
